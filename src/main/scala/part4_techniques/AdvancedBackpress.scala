...
/**
 * Another technique to detach the rate of consumption of elements from the rate of production of elements
 * Use in the case of a slow producer and a fast consumer
 */
...
object AdvancedBackpressure extends App {
  ...
  // ^^ this is an alternative to backpressure
